// Shared chart chrome for every analytics surface in the app (Sprint
// Planner's Performance/Scrum views, the ticket Reports page, and the
// Module 3 analytics dashboard) — one system so charts read consistently
// wherever they appear, rather than each page inventing its own.
